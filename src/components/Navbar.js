...
const Navbar = () => {
    ...
    return (
        <React.Fragment>
            {
                !isMobileNavOpen &&
                <nav className="w-screen bg-primary z-20 h-20 flex items-center justify-between pr-4 pl-4 font-noto fixed md:justify-center">
                    <ul className="md:flex items-center text-base w-5/12 mx-4 justify-end h-full text-btn-text hidden">
                        <li className="mx-2.5 hover:text-secondary cursor-pointer">
                    ...
                    <ul className="md:flex items-center text-base w-5/12 mx-4 h-full text-btn-text hidden">
                        ...
                        <li className="mx-2.5">
                            <Link
                                to="/reservation"
                                className="bg-btn-primary text-btn-text rounded-3xl h-10 px-5 py-3 hover:bg-transparent hover:ring-2 hover:ring-btn-primary hover:text-secondary"
                            >
                                線上預約
                            </Link>
                        </li>
