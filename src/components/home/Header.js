...
const Header = () => {
  return (
    <header className="relative w-screen bg-secondary bg-background-img-2 bg-cover flex h-auto min-h-screen">
        <div className=
               "h-auto min-h-[500px] md:min-h-[750px] w-full xl:w-1/2 text-btn-text pt-40 px-10 xl:px-24 relative block overflow-hidden z-0
        ...
        >
            <h2 className="text-3xl xs-r:text-4xl sm:text-5xl font-semibold font-sati text-left mb-10">Welcome to Hooray</h2>
        ...
        <div className="h-[140vh] xs-max:hidden xs-r:hidden sm-r:hidden xl:w-1/2 flex flex-col pb-16 justify-end items-center">
            <div className="md-r:w-[375px] md-r:h-[275px] lg-r:w-[450px] lg-r:h-[350px] xl:w-[550px] xl:h-[400px] bg-header-img-1 bg-cover -translate-y-20"/>
            <div className="w-full h-52 bg-primary -left-3.5 transform -translate-x-48 flex">
                <div className="w-full lg:w-3/5 h-full px-8 py-6 font-light text-btn-text">
                ...
                <div className="w-0 lg:w-2/5 h-full bg-header-banner bg-cover right-0 z-10"/>
            </div>
        </div>
    </header>
  );
