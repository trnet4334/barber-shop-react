...
const Testimonial = () => {
    ...
    return (
        <div className="w-full h-auto lg:min-h-screen flex flex-col-reverse lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-16 flex flex-col items-start justify-center bg-secondary">
                <h4 className="text-base font-base text-secondary">Customer Feedback</h4>
                <h2 className="text-3xl md:text-4xl mb-5 text-primary">客戶回饋</h2>
                <p className="w-full md:w-2/3 break-words text-left my-3.5 text-primary leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus impedit ipsam libero odit quia sit. Assumenda eaque eveniet facere numquam provident quibusdam sed ut vero voluptates? Commodi dicta ipsa rem?</p>
