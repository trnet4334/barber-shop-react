...
const Protocol = () => {
  ...
  return (
    <section
      className="w-screen lg:min-h-screen h-auto py-16 lg:pt-16 md:pb-0 bg-background-img-2 md:bg-background-img bg-center bg-cover bg-secondary text-primary">
