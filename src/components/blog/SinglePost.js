...
const SinglePost = () => {
    return (
        <div className="divide-y divide-gray-200">
            <div>
                <div className="mb-6">
                    <h4 className="text-sm text-left font-light text-gray-400">Melody Wu / Feb 10, 2021</h4>
                    <h2 className="text-xl text-left text-primary">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h2>
                </div>
                ...
                <div className="bg-news-img-1 w-full h-[325px] bg-cover my-6"/>
