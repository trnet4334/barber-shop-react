    ...
    return (
        <footer className="w-screen h-auto bg-primary flex flex-col justify-between">
            <div className="w-full h-full pt-8 pb-4 flex flex-col md:flex-row items-center justify-center relative font-noto">
                <div className="flex flex-col justify-between text-btn-text text-base w-full pl-8 pb-4 md:pl-0 md:w-1/3 lg:w-1/4 md:py-4">
                ...
                <div className="text-btn-text w-full md:w-1/2 lg:w-2/5">
                    <ul className="flex justify-center divide-x divide-solid divide-primary w-full my-6 sm:mb-12 m-auto text-left text-sm xs:text-base md:text-xl list-none font-light">
