    ...
    <section
      ...
      <div className="w-full flex flex-col-reverse md:flex-row justify-around px-8 lg:px-20 pb-10">
        <Image
          ...
          source='bg-about-img-1'
          width='xs-max:w-full xs-r:w-[80vw] sm-r:w-[80vw] md-r:w-[300px] lg-r:w-[375px] xl:w-[450px]'
          height='xs-max:h-[225px] xs-r:h-[300px] sm-r:h-[300px] md:h-[500px]'
        ...
        <div className="w-full md-r:w-1/2 lg-r:w-1/2 xl:w-2/5 text-left">
          ...
          <p className="font-light break-all leading-relaxed my-3">Lorem ipsum dolor sit amet, consectetur adipisicing
            elit. Accusantium ad alias aliquam amet autem culpa dicta distinctio dolor dolore dolorem doloribus, ducimus
            eaque expedita fugiat, id, in inventore ipsa ipsam iste laborum magni necessitatibus nemo nesciunt nostrum
            omnis possimus provident quaerat quasi qui ratione saepe sit sunt tenetur veritatis vitae voluptate
            voluptatem? At dolor eveniet hic quam quidem quis suscipit!</p>
          <p className="font-light break-all leading-relaxed my-3">Lorem ipsum dolor sit amet, consectetur adipisicing
      ...
      <div
        ...
        <div className="xs-max:w-full md-r:w-1/2 lg:w-2/5 text-left pb-10 md:pb-0">
          ...
          <p className="font-light my-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque blanditiis
            corporis deserunt ducimus eius excepturi in ipsam non quis quod, quos, sunt ullam velit, veritatis
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="font-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est, fuga illo nisi
                  quidem vitae voluptas.</p>
              </div>
            </li>
          </ul>
        </div>
        <Image
          alternate='About Image 2'
          source='bg-about-img-2'
          width='xs-max:w-full xs-r:w-[80vw] sm-r:w-[80vw] md-r:w-[300px] lg-r:w-[375px] xl:w-[600px]'
          height='xs-max:h-[225px] xs-r:h-[250px] sm-r:h-[250px] md:h-[400px]'
          backgroundFeature='bg-center bg-cover'
          position='xs-r:m-auto sm-r:m-auto'
        />
      </div>
      <div className="w-full bg-background-img-2 bg-cover bg-center px-6 md-r:px-12 lg-r:px-18 py-12 xl:py-24 xl:px-52">
        <div className="w-full h-[375px] grid grid-cols-2 grid-rows-2 md:grid-cols-4 md:grid-rows-2 gap-2">
          <Image
            alternate='About Image 3'
            source='bg-about-img-3'
            width=''
            height=''
            backgroundFeature='bg-center bg-cover'
          ...
          />
          <Image
            alternate='About Image 4'
            source='bg-about-img-4'
            width=''
            height=''
            backgroundFeature='bg-center bg-cover'
            position=''
          />
          <Image
            alternate='About Image 6'
            source='bg-about-img-6'
            width=''
            height=''
            backgroundFeature='bg-center bg-cover'
            position='md:row-span-2'
          />
          <Image
            alternate='About Image 5'
            source='bg-about-img-5'
            width=''
            height=''
            backgroundFeature='bg-center bg-cover'
            position=''
